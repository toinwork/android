...
public class TextAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        TextView view;
        if (convertView == null) {
            view = (TextView) LayoutInflater.from(mContext).inflate(R.layout.choose_item, parent,
                    false);
        } else {
        ...
        if (selectedText != null && selectedText.equals(mString)) {
            view.setTextColor(mContext.getResources().getColor(R.color.action_color));
            view.setBackgroundDrawable(mContext.getResources().getDrawable(R.color.white));//设置选中的背景图片
        } else {
