...
public class PinnedHeaderExpandableListView extends ExpandableListView implements OnScrollListener,
    ...
    private PinnedHeaderExpandListViewAdapter mAdapter;
    ...
    public void setHeaderData(int groupPosition) {
        ...
        ((TextView) mHeaderView.findViewById(R.id.tv_name)).setText("- " + groupData);
    ...
    public void setHeaderView(View view) {
        mHeaderView = view;
        mHeaderView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        mAdapter = (PinnedHeaderExpandListViewAdapter) adapter;
    }
