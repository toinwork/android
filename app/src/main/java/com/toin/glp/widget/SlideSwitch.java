...
public class SlideSwitch extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = measureDimension(40, widthMeasureSpec);
    ...
    protected void onDraw(Canvas canvas) {
        if (shape == SHAPE_RECT) {
            ...
            canvas.drawRect(backRect, paint);
            frontRect.set(frontRect_left, RIM_SIZE, frontRect_left + getMeasuredWidth() / 2
                    - RIM_SIZE, getMeasuredHeight() - RIM_SIZE);
            ...
            canvas.drawRoundRect(backCircleRect, radius, radius, paint);
            radius -= RIM_SIZE / 2;
            frontRect.set(frontRect_left, RIM_SIZE, frontRect_left + backRect.height() - 2
                    * RIM_SIZE, backRect.height() - RIM_SIZE);
            frontCircleRect.set(frontRect);
            paint.setColor(Color.WHITE);
            canvas.drawCircle(frontCircleRect.centerX(), frontCircleRect.centerY(), radius, paint);
        }
    }
    ...
    public void moveToDest(final boolean toRight) {
        ValueAnimator toDestAnim = ValueAnimator.ofInt(frontRect_left, toRight ? max_left
                : min_left);
